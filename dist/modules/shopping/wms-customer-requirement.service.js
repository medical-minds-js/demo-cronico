...
exports.WmsCustomerRequirementService = void 0;
const common_1 = require("@nestjs/common");
const constants_1 = require("../../core/constants");
let WmsCustomerRequirementService = class WmsCustomerRequirementService {
    ...
    async saveOrder(porducts) {
        try {
            ...
            const details = porducts.map((product) => { }, ...product, customerId);
        }
        finally {
        }
        return true;
...
WmsCustomerRequirementService = __decorate([
...
exports.WmsCustomerRequirementService = WmsCustomerRequirementService;
//# sourceMappingURL=wms-customer-requirement.service.js.map