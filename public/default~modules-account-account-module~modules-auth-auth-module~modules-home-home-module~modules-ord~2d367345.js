(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~modules-account-account-module~modules-auth-auth-module~modules-home-home-module~modules-ord~2d367345"],{
...
/* harmony import */ var _core_functions_api_value_function__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @core/functions/api-value.function */ "rctL");
...
class OrdersService {
    ...
    getSubscriptionsList(paginate) {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].endpoint +
            `/shopping/list?page=${paginate.page}&itemsPerPage=${paginate.itemsPerPage}`);
    }
    getSubscriptionsById(id) {
        return this.http
            .get(_environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].endpoint + `/shopping/${id}`)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])((res) => {
            const data = Object(_core_functions_api_value_function__WEBPACK_IMPORTED_MODULE_2__["dataValue"])(res);
            data.lastOrder = data.orders.sort((a, b) => a.id - b.id)[0];
            return Object.assign(Object.assign({}, res), { data });
        }));
    }
    updateQuantities(sub) {
        return this.http.put(`${_environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].endpoint}/subscription/update/quantity`, sub);
    }
    updateDelivery(sub) {
        return this.http.put(`${_environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].endpoint}/subscription/update/delivery`, sub);
    }
    updateStatus(sub) {
        return this.http.put(`${_environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].endpoint}/subscription/update/status`, sub);
    }
}
...
class SearchService {
    ...
    getProducts(data) {
        const params = data;
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].endpoint + '/products', { params });
    }
    getProductById(id) {
        return this.http
...
class HomeService {
    ...
    requestNewProduct(data) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].endpoint + '/home/request-supply', data);
    }
}
...
class ShoppingCartService {
    ...
    addShoppingCart(data) {
        ...
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].endpoint + `/shopping-cart/save`, cleanData);
    }
    updateShoppingCart(data) {
        ...
        return this.http.put(_environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].endpoint + `/shopping-cart/update`, cleanData);
    }
    deleteShoppingCart(shoppingCartId) {
        return this.http.delete(_environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].endpoint + `/shopping-cart/delete/${shoppingCartId}`);
    }
...
class AccountService {
    ...
    getData() {
        return this.http
            .get(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].endpoint + '/user/data')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((items) => {
            let user = items.data;
            user.picture = `${_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].domain}${user.picture}`;
            return items;
        }));
    }
    updateData(user) {
        return this.http
            .put(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].endpoint + '/user/data/update', user)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((items) => {
            let user = items.data;
            user.picture = `${_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].domain}${user.picture}`;
            return items;
    ...
    activePayment() {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].endpoint + '/user/account/active-payment', {});
    }
    getPaymentId() {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].endpoint + '/user/account/payment-id', {});
    }
    getAilmentsByUser(name) {
        let params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpParams"]();
        if (name) {
            params = params.append('name', name);
        }
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].endpoint + '/user/ailments', { params });
    }
    addAilmentsToUser(id) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].endpoint + '/user/ailments', { id });
    }
    getUserAilmentsDose(id) {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].endpoint + '/user/ailments/' + id + '/show', {});
    }
    configDoseTake(data) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].endpoint + '/user/ailments/' + data.id + '/config-take', data);
    }
    saveTakeDose(data) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].endpoint + '/user/ailments/' + data.id + '/dose', { id: data.id });
    }
}
AccountService.ɵfac = function AccountService_Factory(t) { return new (t || AccountService)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"])); };
...
/* harmony import */ var src_app_modules_orders_services_orders_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! src/app/modules/orders/services/orders.service */ "5TcN");
...
class AppStoreService extends _base_store_class__WEBPACK_IMPORTED_MODULE_0__["BaseStore"] {
    constructor(sessionService, authService, accountService, homeService, searchService, shoppingCartService, addressService, deliveryTimesService, cardsService, ordersService) {
        super();
    ...
    loadHome() {
        if (this.sessionService.isAuthenticated()) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["forkJoin"])([
                ...
                this.accountService.getData().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(() => Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(null))),
    ...
    loadProducts() {
        ...
        return this.searchService.getProducts(filters).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((response) => {
            const data = Object(_core_functions_api_value_function__WEBPACK_IMPORTED_MODULE_4__["dataValue"])(response);
            return this.changeState(_app_store_actions__WEBPACK_IMPORTED_MODULE_2__["AppStoreActions"].setProducts, {
                search: data.items,
    ...
    loadShopping() {
        let paginate = this.getObjectState().paginationSubs;
        return this.ordersService.getSubscriptionsList(paginate).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((data) => {
            let listResponse = Object(_core_functions_api_value_function__WEBPACK_IMPORTED_MODULE_4__["dataValue"])(data).items;
            return this.changeState(_app_store_actions__WEBPACK_IMPORTED_MODULE_2__["AppStoreActions"].setSubsciptions, {
                subs: listResponse,
            });
        }));
    }
    loadCurrentShopping(id) {
        return this.ordersService.getSubscriptionsById(id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((response) => {
            let data = Object(_core_functions_api_value_function__WEBPACK_IMPORTED_MODULE_4__["dataValue"])(response);
            this.setCurrentSubsciption(data);
            return true;
        }));
    }
    setCurrentSubsciption(sub) {
        this.changeState(_app_store_actions__WEBPACK_IMPORTED_MODULE_2__["AppStoreActions"].setCurrentSub, {
            sub,
        });
    ...
    selectCurrentAilment(ailment) {
        this.changeState(_app_store_actions__WEBPACK_IMPORTED_MODULE_2__["AppStoreActions"].setAilment, {
            ailment,
        });
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(true);
    }
    ...
    showAddAddressForm() {
        return this.changeState(_app_store_actions__WEBPACK_IMPORTED_MODULE_2__["AppStoreActions"].setFormCreateAddress, {
    ...
    showAddressEditForm(editableAddress) {
        return this.changeState(_app_store_actions__WEBPACK_IMPORTED_MODULE_2__["AppStoreActions"].setFormEditAddress, {
    ...
    showEditDeliveryForm(editableAddress) {
        this.changeState(_app_store_actions__WEBPACK_IMPORTED_MODULE_2__["AppStoreActions"].setFormDelivery, {
    ...
    changeDeliveryDate(isCorrectDate, deliveryDate) {
        if (isCorrectDate) {
            const newSubscription = this.getObjectState().currentSubscription;
            newSubscription.nextDelivery = deliveryDate;
            return this.changeState(_app_store_actions__WEBPACK_IMPORTED_MODULE_2__["AppStoreActions"].setCurrentSub, {
                sub: newSubscription,
            });
        }
        else {
    ...
    loadShoppingCart() {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["forkJoin"])([
            ...
            this.getCardsByUser(),
        ]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(([shoppingCart, address, deliveries]) => {
            const data = {
                shoppingCart: Object(_core_functions_api_value_function__WEBPACK_IMPORTED_MODULE_4__["itemsValue"])(shoppingCart),
                address: Object(_core_functions_api_value_function__WEBPACK_IMPORTED_MODULE_4__["itemsValue"])(address).sort((a, b) => a.status > b.status ? -1 : 1),
    ...
    updateShoppingProduct(shoppingProduct) {
        ...
        this.changeState(_app_store_actions__WEBPACK_IMPORTED_MODULE_2__["AppStoreActions"].setShoppingProduct, { shoppingProduct });
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(true);
    }
    saveAddress(newAddress) {
        return this.addressService.addAddress(newAddress).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(() => {
            this.changeState(_app_store_actions__WEBPACK_IMPORTED_MODULE_2__["AppStoreActions"].setPostalCodes, {
                list: [],
            });
    ...
    deleteAddress(addressId) {
        return this.addressService.deleteAddress(addressId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((result) => {
            return this.loadAccountAddressPage();
        }));
    }
    editAddress(newAddress) {
        return this.addressService.updateAddress(newAddress).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(() => {
            return this.loadAccountAddressPage();
        }));
    }
    setActiveAddress(id) {
        return this.addressService.setActiveAddress(id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(() => {
            return this.loadAccountAddressPage();
        }));
    }
    editDelivery(deliveriesTimes) {
    ...
    addCardByUser(card) {
        return this.cardsService
            .addCardByUser(card)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((response) => this.getCardsByUser()));
    }
    getCardsByUser() {
        return this.cardsService.getCardsByUser().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((cards) => {
            this.changeState(_app_store_actions__WEBPACK_IMPORTED_MODULE_2__["AppStoreActions"].setShoppingCards, {
                cards: Object(_core_functions_api_value_function__WEBPACK_IMPORTED_MODULE_4__["itemsValue"])(cards).sort((a, b) => a.active > b.active ? -1 : 1),
            });
            return true;
        }));
    }
    ...
    updateSubscriptionQuantities() {
        let newSub = this.getObjectState().currentSubscription;
        return this.ordersService.updateQuantities(newSub).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(() => {
            this.changeState(_app_store_actions__WEBPACK_IMPORTED_MODULE_2__["AppStoreActions"].setCurrentSub, {
                sub: newSub,
            });
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(true);
    ...
    updateSubscriptionDelivery() {
        let newSub = this.getObjectState().currentSubscription;
        return this.ordersService.updateDelivery(newSub).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(() => {
            this.changeState(_app_store_actions__WEBPACK_IMPORTED_MODULE_2__["AppStoreActions"].setCurrentSub, {
                sub: newSub,
            });
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(true);
    ...
    loadPostalCodes(code) {
        return this.addressService.getPostalCodesList(code).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((res) => {
            let codes = Object(_core_functions_api_value_function__WEBPACK_IMPORTED_MODULE_4__["itemsValue"])(res);
            this.changeState(_app_store_actions__WEBPACK_IMPORTED_MODULE_2__["AppStoreActions"].setPostalCodes, {
                list: codes,
            });
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(true);
    ...
    loadAccountPage() {
        return this.loadHome().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(() => {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["forkJoin"])([
    ...
    loadUserAilmentsPage() {
        return this.accountService.getAilmentsByUser().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((userAilments) => {
            this.changeState(_app_store_actions__WEBPACK_IMPORTED_MODULE_2__["AppStoreActions"].initUserAilmentsSearch, {
                userAilmentsSearch: Object(_core_functions_api_value_function__WEBPACK_IMPORTED_MODULE_4__["itemsValue"])(userAilments),
            });
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(true);
        }));
    }
    searchAilments(text) {
        return this.accountService.getAilmentsByUser(text).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((userAilments) => {
            this.changeState(_app_store_actions__WEBPACK_IMPORTED_MODULE_2__["AppStoreActions"].initUserAilmentsSearch, {
                userAilmentsSearch: Object(_core_functions_api_value_function__WEBPACK_IMPORTED_MODULE_4__["itemsValue"])(userAilments),
            });
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(true);
    ...
    addAilments(id, textSearch) {
        return this.accountService.addAilmentsToUser(id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((response) => {
            return this.searchAilments(textSearch).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(() => response));
        }));
    }
    loadUserAilmentsDetailPage(id) {
        return this.accountService.getUserAilmentsDose(id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((userAilments) => {
            const data = Object(_core_functions_api_value_function__WEBPACK_IMPORTED_MODULE_4__["dataValue"])(userAilments);
            data.userAilmentsProducts = data.userAilmentsProducts.map((item) => (Object.assign(Object.assign({}, item), { editing: !item.firstTake })));
            this.changeState(_app_store_actions__WEBPACK_IMPORTED_MODULE_2__["AppStoreActions"].initUserAilments, {
                userAilments: data,
            });
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(true);
        }));
    ...
    editUserAilmentsProduct(data) {
        return this.accountService.configDoseTake(data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((response) => {
            if (response.status !== 'success') {
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(response);
            }
            return this.loadUserAilmentsDetailPage(this.getObjectState().userAilments.id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(() => response));
        }));
    }
    closeEditUserAilmentsProduct(data) {
        const userAilments = this.getObjectState().userAilments;
        const userAilmentsProducts = userAilments.userAilmentsProducts.map((item) => {
            if (item.id === data.id) {
                return Object.assign(Object.assign({}, item), { editing: false });
            }
            return item;
        });
        this.changeState(_app_store_actions__WEBPACK_IMPORTED_MODULE_2__["AppStoreActions"].initUserAilments, {
            userAilments: Object.assign(Object.assign({}, userAilments), { userAilmentsProducts }),
        });
    }
    submitTakeDose(data) {
        return this.accountService.saveTakeDose(data).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])((response) => {
            if (response.status !== 'success') {
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(response);
            }
            return this.loadUserAilmentsDetailPage(this.getObjectState().userAilments.id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(() => response));
    ...
    loadAccountAddressPage() {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["forkJoin"])([
            this.addressService.getAddressList(),
            this.deliveryTimesService.getDeliveryTimesList(),
        ]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(([address, deliveries]) => {
            const data = {
                address: Object(_core_functions_api_value_function__WEBPACK_IMPORTED_MODULE_4__["itemsValue"])(address).sort((a, b) => a.status > b.status ? -1 : 1),
                deliveries: Object(_core_functions_api_value_function__WEBPACK_IMPORTED_MODULE_4__["itemsValue"])(deliveries),
            };
            return this.changeState(_app_store_actions__WEBPACK_IMPORTED_MODULE_2__["AppStoreActions"].initAccountAddress, data);
        }));
    }
    requestNewProduct(data) {
    ...
    switch (action.type) {
        case _app_store_actions__WEBPACK_IMPORTED_MODULE_0__["AppStoreActions"].init: {
            return {
                ...
                userAilmentsSearch: [],
                userAilments: { ailments: { images: [], name: '' } },
            };
        }
        ...
        case _app_store_actions__WEBPACK_IMPORTED_MODULE_0__["AppStoreActions"].setProducts:
            return Object.assign(Object.assign({}, state), { search: action.payload.search, totalPages: action.payload.totalPages });
        ...
        case _app_store_actions__WEBPACK_IMPORTED_MODULE_0__["AppStoreActions"].setAilment:
            return Object.assign(Object.assign({}, state), { currentAilment: action.payload.ailment });
        case _app_store_actions__WEBPACK_IMPORTED_MODULE_0__["AppStoreActions"].initShoppingCart:
            return Object.assign(Object.assign(Object.assign(Object.assign({}, state), { shoppingCart: action.payload.shoppingCart }), processShoppingCartProducts(action.payload.shoppingCart)), { address: action.payload.address, editableAddress: action.payload.address.find((i) => i.status === 1), deliveriesTimes: action.payload.deliveries });
        case _app_store_actions__WEBPACK_IMPORTED_MODULE_0__["AppStoreActions"].setPostalCodes:
            return Object.assign(Object.assign({}, state), { postalCodes: action.payload.list });
        case _app_store_actions__WEBPACK_IMPORTED_MODULE_0__["AppStoreActions"].setShoppingCart:
            return Object.assign(Object.assign(Object.assign({}, state), { shoppingCart: action.payload.shoppingCart }), processShoppingCartProducts(action.payload.shoppingCart));
        case _app_store_actions__WEBPACK_IMPORTED_MODULE_0__["AppStoreActions"].setAddress:
            return Object.assign(Object.assign({}, state), { address: action.payload.address });
        ...
        case _app_store_actions__WEBPACK_IMPORTED_MODULE_0__["AppStoreActions"].setShoppingProduct:
        ...
        case _app_store_actions__WEBPACK_IMPORTED_MODULE_0__["AppStoreActions"].setShoppingCards:
            return Object.assign(Object.assign({}, state), { cards: action.payload.cards, shoppingAddCard: action.payload.cards.length === 0 });
        ...
        case _app_store_actions__WEBPACK_IMPORTED_MODULE_0__["AppStoreActions"].setFormCreateAddress:
            return Object.assign(Object.assign({}, state), { showAddressAddForm: action.payload.showAddressAddForm, editableAddress: action.payload.editableAddress });
        case _app_store_actions__WEBPACK_IMPORTED_MODULE_0__["AppStoreActions"].setFormEditAddress:
            return Object.assign(Object.assign({}, state), { address: state.address.map((item) => (Object.assign(Object.assign({}, item), { editing: item.id == action.payload.editableAddress.id }))), showAddressEditForm: action.payload.showAddressEditForm, editableAddress: action.payload.editableAddress });
        ...
        case _app_store_actions__WEBPACK_IMPORTED_MODULE_0__["AppStoreActions"].setFormDelivery:
        ...
        case _app_store_actions__WEBPACK_IMPORTED_MODULE_0__["AppStoreActions"].setSubsciptions:
            return Object.assign(Object.assign({}, state), { subscriptions: action.payload.subs });
        case _app_store_actions__WEBPACK_IMPORTED_MODULE_0__["AppStoreActions"].setCurrentSub:
            return Object.assign(Object.assign({}, state), { currentSubscription: action.payload.sub });
        case _app_store_actions__WEBPACK_IMPORTED_MODULE_0__["AppStoreActions"].initUserAilmentsSearch:
            return Object.assign(Object.assign({}, state), { userAilmentsSearch: action.payload.userAilmentsSearch });
        case _app_store_actions__WEBPACK_IMPORTED_MODULE_0__["AppStoreActions"].initUserAilments:
            return Object.assign(Object.assign({}, state), { userAilments: action.payload.userAilments });
        case _app_store_actions__WEBPACK_IMPORTED_MODULE_0__["AppStoreActions"].initAccountAddress:
            return Object.assign(Object.assign({}, state), { address: action.payload.address, deliveriesTimes: action.payload.deliveries });
        default:
            return state;
    }
}
function processShoppingCartProducts(products) {
    const diferent = products
        .map((i) => i.period)
    ...
    if (separateShoppingCart) {
        shoppingCart30 = products.filter((i) => Number(i.period) === 30);
        shoppingCart15 = products.filter((i) => Number(i.period) === 15);
    }
...
class AddressService {
    ...
    getPostalCodesList(code) {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].endpoint + `/postal-codes/list/${code}`);
    }
    addAddress(address) {
        let data = {
            id: null,
    ...
    updateAddress(address) {
        return this.http.put(_environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].endpoint + `/address/update`, address);
    }
    deleteAddress(addressId) {
        return this.http.delete(_environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].endpoint + `/address/delete/${addressId}`);
    }
    setActiveAddress(addressId) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].endpoint + `/address/user/active/${addressId}`, {});
    }
}
...
//# sourceMappingURL=default~modules-account-account-module~modules-auth-auth-module~modules-home-home-module~modules-ord~2d367345.js.map